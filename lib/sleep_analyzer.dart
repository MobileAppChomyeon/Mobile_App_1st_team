...
class SleepAnalyzer {
  ...
  String getSleepFeedback(int score) {
    if (score >= 90) {
      return "완벽한 수면이에요! 최고의 컨디션이겠어요. 😊";
    } else if (score >= 80) {
      return "잘 주무셨네요! 상쾌한 하루 되세요. ✨";
    } else if (score >= 70) {
      return "괜찮은 수면이었어요. 조금 더 신경 쓰면 더 좋아질 거예요. 💪";
    } else if (score >= 60) {
      return "수면 패턴이 불규칙해요. 일정한 시간에 자고 일어나보세요. 🌙";
    } else if (score >= 50) {
      return "수면의 질이 좋지 않아요. 취침 전 루틴을 만들어보는 건 어떨까요? 💭";
    } else {
      return "수면 관리가 필요해요. 규칙적인 수면 습관을 만들어보세요. 😴";
    }
  }
} 